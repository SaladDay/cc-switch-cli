...
[![Version](https://img.shields.io/badge/version-4.2.11-blue.svg)](https://github.com/saladday/cc-switch-cli/releases)
...
curl -LO https://github.com/saladday/cc-switch-cli/releases/latest/download/cc-switch-cli-v4.2.11-darwin-universal.tar.gz

# 解压
tar -xzf cc-switch-cli-v4.2.11-darwin-universal.tar.gz
...
```bash
# 下载
curl -LO https://github.com/saladday/cc-switch-cli/releases/latest/download/cc-switch-cli-v4.2.11-linux-x64-musl.tar.gz

# 解压
tar -xzf cc-switch-cli-v4.2.11-linux-x64-musl.tar.gz
...
```bash
# 适用于树莓派或 ARM 服务器
curl -LO https://github.com/saladday/cc-switch-cli/releases/latest/download/cc-switch-cli-v4.2.11-linux-arm64-musl.tar.gz
tar -xzf cc-switch-cli-v4.2.11-linux-arm64-musl.tar.gz
chmod +x cc-switch
sudo mv cc-switch /usr/local/bin/
```
...
```powershell
# 下载 zip 文件
# https://github.com/saladday/cc-switch-cli/releases/latest/download/cc-switch-cli-v4.2.11-windows-x64.zip
